...
func TestEncodeLogRecord(t *testing.T) {
	// 正常情况
	// record size : 21, header length: 7, crc: 2532332136.
	// record : [104 82 240 150 0 8 20 110 97 109 101 98 105 116 99 97 115 107 45 103 111]
	// header : [104 82 240 150 0 8 20]
	rec1 := &LogRecord{
		Key:   []byte("name"),
